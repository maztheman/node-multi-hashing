...
{
  __declspec(align(32)) char  str[38]  ;// __attribute__((aligned(32))); // 26 + 11 + 1
  __declspec(align(32)) uint32_t prehash[5];// __attribute__((aligned(32)));
  __declspec(align(32)) uint32_t hash[5];// __attribute__((aligned(32))) = { 0 };
  int i = 0;
  SHA_CTX ctx;
  SHA1_Init(&ctx);
